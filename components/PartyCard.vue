      ...
      <div class="d-block text-left custom-font" >
        <b-container class="bv-example-row">
          ...
          <b-row>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b-col>
              <p style="font-size:12px; color:gray; float:left; "><b style="color:black;">{{infoData.date}} <fa style="font-size:3px; margin-top:1px;" icon="circle"/> {{infoData.time}}</b> 
    ...
    <button @click="showModal" class="rectangle" style="padding:16px 12px 2px 12px">
      <b-container class="bv-example-row">
        ...
        <b-row >
          ...
          <b-col></b-col>
          <b-col></b-col>
          <b-col><fa style="width: 20px; height: 20px; float:right;color:rgba(255, 107, 48, 1.0); display:inline;margin:-14px -10px 0px 0px" icon="angle-right"/></b-col>
        </b-row>
      </b-container>
